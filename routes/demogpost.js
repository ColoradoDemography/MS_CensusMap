...
var schema = req.body.schema ||  function(){
  if(db==='acs1822' || db==='acs1721' || db==='acs1620' || db==='acs1519' || db==='acs1418' || db==='acs1317' || db==='acs1216' || db==='acs1115' || db==='acs1014' || db==='acs0913' || db==='acs0812' || db==='acs0711' || db==='acs0610' || db==='c2010' ){return 'data';}
...
var moe='no';
if(db==='acs1822' || db==='acs1721' || db==='acs1620' || db==='acs1519' || db==='acs1418' || db==='acs1317' || db=='acs0610' || db=='acs0711' || db=='acs0812' || db=='acs0913' || db=='acs1014' || db=='acs1115' || db=='acs1216'){
  if (req.body.moe){
    moe=req.body.moe;
  }
} 
...
//push $_POST vars into simple array for each $key
  ...
  //validate database selected
    if(db!=='c1980' && db!=='c1990' && db!=='c2000' && db!=='c2010' && db!=='acs0610' && db!=='acs0711' && db!=='acs0812' && db!=='acs0913' && db!=='acs1014' && db!=='acs1115' && db!=='acs1216' && db!=='acs1317' && db!=='acs1418' && db!=='acs1519' && db!=='acs1620' && db!=='acs1721' && db!=='acs1822'){
